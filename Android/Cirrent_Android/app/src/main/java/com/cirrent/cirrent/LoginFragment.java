            ...
            loginButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (username.length() == 0 || password.length() == 0) {
                        Toast.makeText(LoginFragment.this.getContext(), "Wrong Email or Password", Toast.LENGTH_LONG).show();
                        return;
                    }
        ...
        SampleCloudService.sharedService().login(username, password, new SampleCloudService.SampleCompletionHandler() {
            ...
            public void completion(boolean bSuccess) {
                ...
                if (bSuccess == true) {
                    ...
                    Toast.makeText(LoginFragment.this.getContext(), "We had a problem signing you in. Please try again.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
