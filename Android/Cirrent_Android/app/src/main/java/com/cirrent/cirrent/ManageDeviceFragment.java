        ...
        public View generateView(final int position, ViewGroup parent) {
                ...
                public void onClick(View v) {
                    ...
                    SampleCloudService.sharedService().resetDevice(device.deviceID, new SampleCloudService.SampleCompletionHandler() {
                        ...
                        public void completionResetDevice(boolean bSuccess) {
                            ...
                            if (bSuccess == true) {
                                CirrentService.sharedService().resetDevice(SampleCloudService.sharedService().manage_token, device.deviceID, new CompletionHandler(){
                                    @Override
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    inputView.setText(device.friendlyName);
                    ...
                    new AlertDialog.Builder(MainActivity.currentActivity).setTitle("Custom Device Name").setMessage(null).setView(inputView).setPositiveButton("Save", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (inputView.getText().toString().length() > 0) {
                                device.friendlyName = inputView.getText().toString();
            ...
            if (device.friendlyName != null && device.friendlyName.compareTo("null") != 0) {
                friendlyNameView.setText(device.friendlyName);
            }
            else {
                friendlyNameView.setText(device.deviceID);
            }
