...
public class ManageNetworkFragment extends Fragment {
    ...
    public class NetworkAdapter extends BaseSwipeAdapter {
        ...
        public View generateView(final int position, ViewGroup parent) {
            ...
            Button delete = (Button) rowView.findViewById(R.id.delete_network);

            delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ProgressView.sharedView().show(getContext(), "Removing Network from your device...");
                    CirrentService.sharedService().deleteNetwork(SampleCloudService.sharedService().manage_token, device.deviceID, network, new CompletionHandler(){
                        @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        CirrentService.sharedService().getKnownNetworks(SampleCloudService.sharedService().manage_token, device.deviceID, new CompletionHandler(){
            @Override
