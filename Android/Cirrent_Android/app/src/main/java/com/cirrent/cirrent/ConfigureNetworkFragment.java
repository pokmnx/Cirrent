...
public class ConfigureNetworkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (networks == null || networks.size() == 0) {
            ProgressView.sharedView().showToast(getContext(), "Sorry, the device isn't in range of any networks. Please try again.");
    ...
    void sendCredential() {
        ...
        CirrentService.sharedService().putPrivateCredentials(SampleCloudService.sharedService().manage_token, new CompletionHandler() {
            @Override
