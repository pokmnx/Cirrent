//
//  PrivateNetworkPopOverView.swift
//  SamsungARTIK
//
...
protocol PrivateNetworkPopOverDelegate {
...
class PrivateNetworkPopOverView: UIView, UIGestureRecognizerDelegate, UITextFieldDelegate {
    ...
    var delegate: PrivateNetworkPopOverDelegate?
    var isToastPresent: Bool! = false
    var savePassword : Bool = true
    var savedPassword : String!
    var wifiSSID: String!
    
    init (frame : CGRect, ssid: String) {
        wifiSSID = ssid
    ...
    func showSuccesfulMessage() {
        ...
        indicatorViewTopLabel.text = "Success"
        indicatorViewBottomLabel.text = ""
    }
