...
-(void)drawRect:(CGRect)rect{
    const CGFloat *color=CGColorGetComponents([UIColor colorWithRed:0.702 green:0.000 blue:0.000 alpha:1.000].CGColor);
    ...
    border.backgroundColor = [UIColor colorWithRed:0.702 green:0.000 blue:0.000 alpha:1.000];
    [border setAutoresizingMask:UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleBottomMargin];
    border.frame = CGRectMake(0, 0, view.frame.size.width, 3);
...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
//        self.layer.borderColor = [UIColor colorWithRed:27/255.0 green:49/255.0 blue:69/255.0 alpha:1].CGColor;
